...
module.exports = function (connector, swaggerObject) {
  ...
  function translateParameters (params) {
    ...
    _.forEach(params, function (param) {
      if (param.schema && param.schema.$ref) {
        ...
        var model = type && param.modelSignature.definitions && param.modelSignature.definitions[type]
        var definition = model && model.definition
        var properties = definition && definition.properties
        var required = definition && definition.required || []
  ...
  function parseMethodName (options, verb, path) {
    ...
    var verbMap = (options && options.verbMap) || {
      POST: 'create',
      GET: 'find',
      PUT: 'update',
      DELETE: 'delete'
